...
#define N 106
#define ERRORS {"Undefined error: 0", "Operation not permitted",               \
...
char* s21_strtok(char* str, const char* delim); //Портит исходную строку так как записывает вместо симфола разделителя '\0' и в итоге при послдуюзих обращениях к этой строке мы видим только часть до первого разделителя
